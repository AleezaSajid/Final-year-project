...
/** Same scroll-reveal pattern as SewServeLandingPage "How It Works" / Features sections */
const sectionReveal = {
...
const MotionHeaderBlock = motion(HeaderBlock);
const MotionTwoCol = motion(TwoCol);
const MotionImageCol = motion(ImageCol);
...
export default function SignInPage() {
  ...
  return (
    <Page>
      ...
      >
        <MotionHeaderBlock variants={sectionReveal}>
          <LogoRow>
            <LogoHomeLink to="/" aria-label="SewServe — Home">
              <HeaderLogoImg src={logoDisplaySrc} alt="" />
            </LogoHomeLink>
          </LogoRow>
          <PageTitle>Customer Account</PageTitle>
          <Subtitle>Sign in to book fittings and manage vorders.</Subtitle>
        </MotionHeaderBlock>

        <MotionTwoCol variants={twoColStagger}>
          <MotionImageCol variants={sectionReveal}>
            <HeroImg
              src={HERO_IMAGE}
          ...
          <MotionCard variants={sectionReveal}>
            <CardLogo>
              <LogoHomeLink to="/" aria-label="SewServe — Home">
